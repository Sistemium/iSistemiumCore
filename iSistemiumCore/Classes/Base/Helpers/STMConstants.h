...
#define NOTIFICATION_SYNCER_HAVE_UNSYNCED_OBJECTS @"haveUnsyncedObjects"
#define NOTIFICATION_SYNCER_HAVE_NO_UNSYNCED_OBJECTS @"haveNoUnsyncedObjects"
...
#define WK_MESSAGE_SCANNER_OFF @"barCodeScannerOff"
...
#define WK_MESSAGE_UNSYNCED_INFO @"unsyncedInfoService"
#define WK_MESSAGE_CMERA_ROLL @"sendToCameraRoll"
#define WK_MESSAGE_LOAD_IMAGE @"loadImage"
#define WK_MESSAGE_SAVE_IMAGE @"saveImage"
#define WK_MESSAGE_COPY_CLIPBOARD @"copyToClipboard"
#define WK_MESSAGE_GET_CONTACTS @"getContacts"
#define WK_MESSAGE_NAVIGATE @"navigate"
#define WK_MESSAGE_OPEN_URL @"openUrl"
#define WK_MESSAGE_SHARE @"share"
#define WK_MESSAGE_SWITCH_TAB @"switchTab"
#define WK_MESSAGE_SYNCER_INFO @"syncerInfoJSFunction"

#define WK_SCRIPT_MESSAGE_NAMES @[WK_MESSAGE_ERROR_CATCHER, WK_MESSAGE_POST, WK_MESSAGE_GET, WK_MESSAGE_SCANNER_ON, WK_MESSAGE_SCANNER_OFF, WK_MESSAGE_FIND_ALL, WK_MESSAGE_FIND, WK_MESSAGE_UPDATE, WK_MESSAGE_UPDATE_ALL, WK_MESSAGE_DESTROY, WK_MESSAGE_SOUND, WK_MESSAGE_TABBAR, WK_MESSAGE_SUBSCRIBE, WK_MESSAGE_REMOTE_CONTROL, WK_MESSAGE_ROLES, WK_MESSAGE_CHECKIN, WK_MESSAGE_GET_PICTURE, WK_MESSAGE_TAKE_PHOTO, WK_MESSAGE_UNSYNCED_INFO, WK_MESSAGE_CMERA_ROLL, WK_MESSAGE_LOAD_IMAGE, WK_MESSAGE_SAVE_IMAGE, WK_MESSAGE_COPY_CLIPBOARD, WK_MESSAGE_GET_CONTACTS, WK_MESSAGE_NAVIGATE, WK_MESSAGE_SWITCH_TAB, WK_MESSAGE_OPEN_URL, WK_MESSAGE_SHARE,WK_MESSAGE_SYNCER_INFO]
